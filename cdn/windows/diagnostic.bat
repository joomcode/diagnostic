...
nslookup img-edg.joomcdn.net > "%out%\dns.edg.txt"

tracert img-alt.joomcdn.net > "%out%\trace.alt.txt"
tracert img-amz.joomcdn.net > "%out%\trace.amz.txt"
tracert img-edg.joomcdn.net > "%out%\trace.edg.txt"
certutil.exe -urlcache -f "http://iam.gcdn.co/info" "%out%\gcore.txt"
certutil.exe -urlcache -f "http://iam.edgecenter.ru/info" "%out%\edgecenter.txt"
...
certutil.exe -urlcache -f "http://img-edg.joomcdn.net/%cat%" "%out%\cat_edg_http.jpg" > "%out%\cat_edg_http.out" 2> "%out%\cat_edg_http.err"
...
certutil.exe -urlcache -f "https://img-edg.joomcdn.net/%cat%" "%out%\cat_edg_https.jpg" > "%out%\cat_edg_https.out" 2> "%out%\cat_edg_https.err"
